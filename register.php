...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO users(name,email,password,estado) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "','" . $estado ."')")) {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Mediante la simple utilización de Login / Registro y al contratar cualquiera de los servicios ofrecidos a través de Login / Registro, el Cliente reconoce haber leído y acepta los términos expuestos en el presente Acuerdo y / o las políticas que formen parte del mismo.
        <br>
        <br>
        <p>
        	<b>Uso de la cuenta de usuario en Login / Registro</b>
        </p>
		<p>
			<ul>
